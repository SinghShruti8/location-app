...
ENV DJANGO_SETTINGS_MODULE=locationapp.settings
...
RUN conda env create -n locationapp --file ENV.yml

## Make RUN commands use the new environment
## See https://pythonspeed.com/articles/activate-conda-dockerfile/ for explanation
RUN echo "conda activate locationapp" >> ~/.bashrc
...
CMD gunicorn locationapp.wsgi --config gunicorn.conf.py
